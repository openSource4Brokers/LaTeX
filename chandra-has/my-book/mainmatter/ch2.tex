...
\section{Figures}
You can import external graphics\index{graphics} using package graphicx.
...
%(Figure~\ref{fig:Nature-1}).
Using pdflatex several graphics formats are supported: pdf, png and jpg.
Modern installations of LaTeX\index{Latex} can use eps files as well, but indirectly.
...
Keeping in mind that LaTeX is not a spreadsheet, it makes sense to use a dedicated tool to build tables
...
%See sample table~\ref{tab:This table shows some data}.
